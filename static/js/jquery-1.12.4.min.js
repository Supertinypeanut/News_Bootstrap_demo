...
(function(w) {
  //设置基地址
  const bastURL = 'http://localhost:8080/api/v1',
    requestURL = {
      search: bastURL + '/index/search', //文章搜索
      category: bastURL + '/index/category', //文章类型
      hotpic: bastURL + '/index/hotpic', //热点图
      rank: bastURL + '/index/rank', //文章热门排行
      latest: bastURL + '/index/latest', //最新资讯
      latest_comment: bastURL + '/index/latest_comment', //最新评论
      attention: bastURL + '/index/attention', //焦点关注 
      artitle: bastURL + '/index/artitle', //文章详细内容
      post_comment: bastURL + '/index/post_comment', //发表评论
      get_comment: bastURL + '/index/get_comment' //评论列表
    }
